...
public class Main {
    public static void main(String[] args) {
       ...
       short willGet = (short) (paper / (teacherLP +teacherAC +teacherEA));
        ...
        byte time4 = 3;
        byte time5 = 1;
        short bottle20 = (short) ((bottle2 /2) * time1);
        System.out.println( "За " + time1 + " минут машина произвела " + bottle20 + "штук бутылок");
        short bottle60 = (short) ((bottle2 /2) * time2);
        System.out.println( "За " + time2 + " минут машина произвела " + bottle60 + "штук бутылок");
        short bottleDay = (short) ((bottle2 /2) * time3);
        System.out.println( "За сутки машина произвела " + bottleDay+ " штук бутылок");
        int bottle3 =  ((bottle2 /2) * (bottleDay*3));
        System.out.println( "За " + time4 + " дня машина произвела " + bottle3 + " штук бутылок");
        int bottle30 =  ((bottle2 /2) * (bottleDay*30));
        System.out.println( "За " + time5 + " месяц машина произвела " + bottle30 + "штук бутылок");
        //Задача 5
        byte allPaints = 120;
        byte white = 2;
        byte brown = 4;
